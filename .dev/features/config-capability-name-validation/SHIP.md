# SHIP — config-capability-name-validation
...
- Run ended at **GATE 2**. The human's standing instruction for this batch: open a PR and merge it
  only if its CI checks are green.
