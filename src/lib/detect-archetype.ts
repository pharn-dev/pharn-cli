 ...
 * directory + its lowercased ancestor-directory `segments` (the path from `root`
 * to the entry's parent; `[]` at the top level) → the raw signals it
 ...
 * location-independent signal (archetype.ts).
 */
