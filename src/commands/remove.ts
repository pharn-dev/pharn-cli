...
export async function runRemove(
  ...
  // Comes before the skill/module dispatch — an archetype config has neither.
...
// ---------------------------------------------------------------------------
// §A2 — remove a capability (archetype install; no clone, no network)
// ---------------------------------------------------------------------------
...
// removal is a precise recursive delete (siblings never touched) — mirrors
// removeSkill. Touches only `capabilities` (never archetypes / modules).
